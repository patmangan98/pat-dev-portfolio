        ...
        <section className="min-h-screen">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              ...
              <a href="https://github.com/patmangan98">
              <AiFillGithub />
              </a>
            </div>
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            ...
            <div className="basis-1/3 flex-1"
              ...
              {showParagraph4 ? (
                ...
                <div> 
                <p className="text-md py-5 leading-8 text-gray-800 dark:text-gray-200 max-w-xl mx-auto md:text-xl">Ribbit is the perfect app for hobbyists who want to connect and share their passion with like-minded enthusiasts. Ribbit offers a platform where users can start threads on their favorite topics and connect with other hobbyists who share the same interests. With Ribbit, you can post within threads, comment on other users posts, and engage in meaningful discussions with other enthusiasts. Whether you are interested in crafting, cooking, or collecting, Ribbit has a wide range of topics to choose from. So, join the Ribbit community today and start sharing your passion with the world</p>
