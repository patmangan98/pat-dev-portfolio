        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              Since transitioning careers, I have built multiple projects as you can see below. Hover over the project to read more, and click to Check it out!
            </p>
          </div>

          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            <div className="basis-1/3 flex-1 " onMouseEnter={() => setShowParagraph1(false)}
              onMouseLeave={() => setShowParagraph1(true)}>
              {showParagraph1 ? (
                <Image
